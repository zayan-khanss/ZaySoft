...
<head>
    ...
    <title>ZaySoft - Professional WordPress Website Development Services</title>
    ...
    <style>
        ...
        .hero-bg {
            background-image: linear-gradient(135deg, rgba(59, 130, 246, 0.9) 0%, rgba(37, 99, 235, 0.9) 100%), url('https://cdn1.genspark.ai/user-upload-image/22_generated/425c7d76-d719-4878-b5ce-b71e7e18b214');
